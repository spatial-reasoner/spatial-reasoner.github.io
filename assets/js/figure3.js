function figure3() {
    ...
    var indicator_data = [
        { x: 0, y: 0, id: 1, opacity: 1.0, image_list:['1.png', '2.png', '3.png']},
        { x: indicator_image_size + indicator_image_padding, y: 0, id: 2, opacity: 0.2, image_list:['1.png', '2.png', '3.png']},
        { x: 2 * (indicator_image_size + indicator_image_padding), y: 0, id: 3, opacity: 0.2, image_list:['1.png', '2.png']},
        { x: 3 * (indicator_image_size + indicator_image_padding), y: 0, id: 4, opacity: 0.2, image_list:['1.png', '2.png', '3.png', '4.png']},
        { x: 4 * (indicator_image_size + indicator_image_padding), y: 0, id: 5, opacity: 0.2, image_list:['1.png', '2.png', '3.png']},
        { x: 5 * (indicator_image_size + indicator_image_padding), y: 0, id: 6, opacity: 0.2, image_list:['1.png', '2.png']},
    ]
    ...
    function image_init(image_data) {
        ...
        indicator_images.enter()
            ...
            .attr('xlink:href', function(d) {
                return "images/search/" + `sample${d.id}`+ '/origin.png';
            })
