function figure1() {
    ...
    function select_new_image(row, i) {
        ...
        var interp_file = base_dir + 'origin.png';
    ...
    function image_init(image_data) {
        ...
        indicator_images.enter()
            ...
            .attr('xlink:href', function(d) {
                return "images/examples/" + d.id + '/origin.png';
            })
    ...
    function changeMainImage() {
        var newImagePath = 'images/examples/' + base_image_name + '/new.png'; // Path to the new image
    ...
    // Append the button next to the image group
